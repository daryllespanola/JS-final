...
var LevelSelectLayer = cc.Layer.extend({
	...
	init:function()
	{
		...
		var level10 = new cc.MenuItemImage(
			"#ui_btn_lvl.png",
			"#ui_btn_lvl.png",
			this.startLevel10,
			this);
		...
		var level11 = new cc.MenuItemImage(
			"#ui_btn_lvl.png",
			"#ui_btn_lvl.png",
			this.startLevel11,
			this);
		...
		var level12 = new cc.MenuItemImage(
			"#ui_btn_lvl.png",
			"#ui_btn_lvl.png",
			this.startLevel12,
			this);
		...
		var levelMenu = new cc.Menu(level1, level2, level3, level4, level5, level6, level7, level8, level9, level10, level11, level12);
